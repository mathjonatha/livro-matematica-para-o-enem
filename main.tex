...
\draw (current page.center) node [fill=ocre!30!white,fill opacity=0.6,text opacity=1,inner sep=1cm]{\Huge\centering\bfseries\sffamily\parbox[c][][t]{\paperwidth}{\centering Matemática no ENEM\\[15pt] % Book title
{\Large Monitoria AnnWay}\\[20pt] % Subtitle
{\huge Lucas, Marcelo e Matheus}}}; % Author name
\end{tikzpicture}
\vfill
\endgroup
...
\noindent Copyright \copyright\ 2020 Monitoria AnnWay\\ % Copyright notice
...
\noindent \textit{Primeira versão, junho de 2020} % Printing/edition date

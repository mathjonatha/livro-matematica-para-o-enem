...
\definecolor{corobs}{RGB}{255,0,0}
...
\newtheorem{exerciseT}{Problema}[chapter]
...
%\newenvironment{definition}{\begin{caixaEX}\begin{definitionT}}{\end{definitionT}\end{caixaEx}}	
...
%\newenvironment{example}{\begin{exampleT}}{\hfill{\hfill{\color{corsecundaria}\tiny}\end{exampleT}}
%	REMARK ENVIRONMENT
%--------------------------------------------------------------------
